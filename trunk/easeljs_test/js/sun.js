...
(function(namespace){
	...
	Sun.prototype.initialize = function() {
		...
		var timeline = new Timeline();
		timeline.addTween(
					tween.to({rotation:360,x:300,y:0,alpha:0.4},4000, Ease.linearOut )
					.to({rotation:0, x:600,y:0,alpha:0.8},4000, Ease.linearOut )
					.to({rotation:360, x:1000,y:100,alpha:1},4000, Ease.linearOut )
			);
